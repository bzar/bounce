...
cljs_pong.ball.point_in_rect = (function point_in_rect(point,rect){var and__3431__auto__ = "x's";if(cljs.core.truth_(and__3431__auto__))
{var and__3431__auto____$1 = (new cljs.core.Keyword(null,"x","x",1013904362).cljs$core$IFn$_invoke$arity$1(point) >= new cljs.core.Keyword(null,"x","x",1013904362).cljs$core$IFn$_invoke$arity$1(rect));if(and__3431__auto____$1)
{var and__3431__auto____$2 = (new cljs.core.Keyword(null,"x","x",1013904362).cljs$core$IFn$_invoke$arity$1(point) <= (new cljs.core.Keyword(null,"x","x",1013904362).cljs$core$IFn$_invoke$arity$1(rect) + new cljs.core.Keyword(null,"width","width",1127031096).cljs$core$IFn$_invoke$arity$1(rect)));if(and__3431__auto____$2)
{var and__3431__auto____$3 = "y's";if(cljs.core.truth_(and__3431__auto____$3))
{return ((new cljs.core.Keyword(null,"y","y",1013904363).cljs$core$IFn$_invoke$arity$1(point) >= new cljs.core.Keyword(null,"y","y",1013904363).cljs$core$IFn$_invoke$arity$1(rect))) && ((new cljs.core.Keyword(null,"y","y",1013904363).cljs$core$IFn$_invoke$arity$1(point) <= (new cljs.core.Keyword(null,"y","y",1013904363).cljs$core$IFn$_invoke$arity$1(rect) + new cljs.core.Keyword(null,"height","height",4087841945).cljs$core$IFn$_invoke$arity$1(rect))));
} else

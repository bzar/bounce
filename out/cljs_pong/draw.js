...
cljs_pong.draw.draw_surface.beginPath();
var x_4802 = new cljs.core.Keyword(null,"x","x",1013904362).cljs$core$IFn$_invoke$arity$1(ball);var y_4803 = new cljs.core.Keyword(null,"y","y",1013904363).cljs$core$IFn$_invoke$arity$1(ball);var r_4804 = new cljs.core.Keyword(null,"radius","radius",4370292740).cljs$core$IFn$_invoke$arity$1(ball);var arc_start_4805 = 0;var arc_length_4806 = (2 * Math.PI);cljs_pong.draw.draw_surface.arc(x_4802,y_4803,r_4804,arc_start_4805,arc_length_4806);
...
cljs_pong.draw.draw_score = (function draw_score(id,score){var elem = document.getElementById(id);return elem.innerHTML = [cljs.core.str(score)].join('');
});
...
{var scores = new cljs.core.Keyword(null,"score","score",1123168772).cljs$core$IFn$_invoke$arity$1(state);cljs_pong.draw.draw_score.call(null,"player-1-score",new cljs.core.Keyword(null,"player-1","player-1",2893176759).cljs$core$IFn$_invoke$arity$1(scores));
return cljs_pong.draw.draw_score.call(null,"player-2-score",new cljs.core.Keyword(null,"player-2","player-2",2893176760).cljs$core$IFn$_invoke$arity$1(scores));
} else
{return null;
}
});
